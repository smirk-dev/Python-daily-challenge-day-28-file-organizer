...
**Day 28 of #30DaysOfPython**  

A **Smart File Organizer** built using **Python and Tkinter** that automatically sorts files into categories like images, documents, videos, audio, and more. The app features a **modern dark UI**, supports **custom categories**, and logs all actions performed.  

## 🚀 Features  
✅ **Automatic File Organization** - Sorts files into predefined categories like Images, Documents, Videos, etc.  
✅ **Custom Categories** - Add your own file categories with specific extensions.  
✅ **GUI Interface** - A sleek, dark-mode Tkinter UI with interactive elements.  
✅ **Progress Bar & Logs** - Displays the progress of file organization and generates a log file.  
✅ **Multithreading** - Ensures smooth UI operation without freezing during organization.  
